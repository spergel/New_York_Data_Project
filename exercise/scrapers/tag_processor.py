...
EXERCISE_KEYWORDS = {
    ...
    'yoga': ['yoga', 'yoga class', 'yoga studio', 'yoga studio class', 'yoga class', 'yoga studio'],
...
def setup_directories():
    ...
    script_dir = Path(__file__).parent.absolute()  # scrapers directory
    exercise_root = script_dir.parent  # exercise directory
    
    # Set up input and output directories
    input_dir = exercise_root / 'scrapers' / 'data'
    output_dir = exercise_root / 'data'
