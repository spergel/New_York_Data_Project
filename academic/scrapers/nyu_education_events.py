...
BASE_URL = "https://steinhardt.nyu.edu/events"
...
def scrape_nyu_education_events() -> Dict[str, List[Dict]]:
...
def main():
	try:
		result = scrape_nyu_education_events()
		print(f"NYU Education events scraped: {len(result.get('events', []))}")
		# Save debug file
