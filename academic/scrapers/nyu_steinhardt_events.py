        ...
        for teaser in event_teasers:
            try:
                ...
                if event_date:
                    ...
                    # Convert event_date to timezone-aware (EST/EDT for NYU)
                    # NYU is in Eastern Time (UTC-5 EST, UTC-4 EDT)
                    # For simplicity, we'll use UTC and let the frontend handle display
                    if time_text:
                        ...
                        if parsed_start_time and parsed_end_time:
                            ...
                            # For now, use EST (UTC-5) - could be improved to detect DST
