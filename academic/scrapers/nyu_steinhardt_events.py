    ...
    try:
        ...
        for teaser in event_teasers:
            try:
                ...
                if event_date:
                    # Generate unique ID
                    event_id = f"evt_nyu_steinhardt_{hash(title + str(event_date)) % 100000000:08x}"
                    ...
                    event = {
                        ...
                        "location_id": None,
                        "community_id": None,
                        "category": "arts_education",
                        "url": event_url,
                        "source": "nyu_steinhardt",
                        "source_group": "nyu_steinhardt",
                        "source_name": "nyusteinhardt",
                        ...
                        "metadata": {
                            ...
                            "original_source": "NYU Steinhardt",
